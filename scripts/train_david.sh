...
# Set up conda for non-interactive shell
...
cd /home/chend5/protoecgnet/src

CMD="srun --output=\"/gpfs/data/bbj-lab/users/chend5/scripts/logs/${job_name}.txt\" --error=\"/gpfs/data/bbj-lab/users/chend5/scripts/logs/${job_name}.err\" python3 main.py \
  --job_name \"$job_name\" \
  --epochs \"$epochs\" \
...
# Run the command
eval $CMD > "/gpfs/data/bbj-lab/users/chend5/scripts/logs/${job_name}_results.txt"
