python3 ../src/main.py \
    --job_name "2D_global_classifier1" \
    --epochs 200 \
    --batch_size 32 \
    --lr 0.0001 \
    ...
    --proto_time_len 32 \
    --proto_dim 512 \
    --pretrained_weights "/gpfs/data/bbj-lab/users/chend5/experiments/checkpoints/2D_global_projection1/2D_global_projection1_projection.pth"